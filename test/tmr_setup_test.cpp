...
void loop()
{
    ...
    // ════════════════════════════════════════════════════════
    //  DRIVE — yaw + commands (Drive already prints)
    // ════════════════════════════════════════════════════════
    /*
    ...
    */
    ...
    // ════════════════════════════════════════════════════════
    //  I2C MUX SCAN (run once then comment out)
    // ════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════
    // IR SENSORS (mux2, channels 10-13)
    // ════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════
    // RAW MUX1 — all 16 channels (QTR debug)
    // ════════════════════════════════════════════════════════
    /*
    Serial.print(F("MUX1: "));
    mux1.debugPrint();
    */
    ...
    // ════════════════════════════════════════════════════════
    // RAW MUX2 — all 16 channels (IR debug)
    // ════════════════════════════════════════════════════════
